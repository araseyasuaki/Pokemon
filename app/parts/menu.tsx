      ...
      <section className="fixed top-0 left-0 w-52 h-screen shadow-xl overflow-y-scroll">
        <section className="h-aout overflow-hidden">
          <nav className="flex flex-col my-16">
            ...
            <button onClick={areaBtn} className="relative h-14 py-5 px-6 pl-8 font-bold hover:bg-blue-100 hover:text-blue-700 transition duration-400 ease-out text-left">地方別
